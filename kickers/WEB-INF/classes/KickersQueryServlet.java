...
public class KickersQueryServlet extends HttpServlet {  // JDK 6 and above only
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try {
        ...
        if (authors == null) {
         ...
         out.println("<form method='get' action='kickersorder'>");
         ...
         out.println("<p>Upload profile picture here: <input type='file' name='fileToUpload'/></p>"); //for file upload
